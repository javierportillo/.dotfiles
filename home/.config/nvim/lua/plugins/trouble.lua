return {
  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<leader>xf", function() require("trouble").toggle("telescope") end)
      ...
      vim.keymap.set("n", "]X", function() require("trouble").last({ skip_groups = true, jump = true }) end)
    end
  }
}
