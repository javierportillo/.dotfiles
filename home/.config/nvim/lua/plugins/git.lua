return {
  ...
  },
  {
    ...
    config = function()
      ...
      vim.keymap.set({ 'n', 'x' }, '<leader>Dh', '<CMD>DiffviewFileHistory<CR>', { desc = 'Log File History' })
      vim.keymap.set('n', '<leader>Df', '<CMD>DiffviewFileHistory %<CR>', { desc = 'Log This File History' })
